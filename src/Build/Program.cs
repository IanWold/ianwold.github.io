    ...
    class Program
    {
        static void Main(string[] args) =>
            ...
            .Use(dir =>
            {
                ...
                foreach (MetalsharpFile file in dir.OutputFiles
                    .Where(file => file.Directory == ".\\Posts")
                    .OrderByDescending(file => DateTime.TryParse(file.Metadata["date"] as string, out DateTime date) ? ((date.Year * 10000) + (date.Month * 100) + date.Day) : 0))
                {
        ...
        static void LeveledFiles(MetalsharpProject directory)
        {
