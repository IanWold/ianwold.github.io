;;;
{
	"title": "Provocative Holub Opinion Tier List",
	"description": "Ranking a bunch of hashtags",
	"date": "15 February 2026",
	"contents": false,
	"hero": "photo-1578928534298-9747fc52ec97",
    "topics": ["Industry", "Processes"],
    "related": [
...
If you're new to my blog, one important thing to note is that my thinking regarding team and organizational practices tends to align with that of [Allen Holub](https://holub.com/), at least so far as what I've gleaned from a number of talks and blog posts he's done.

Holub has come upon a number of beliefs which, while not necessarily being among the most controversial opinions in our industry, are nonetheless heterodox to the normal prescriptions we find in our industry with respect to organization. He has branded a number of these in a hashtag format such as "#NoStandups" or "#NoRetrospectives," stemming from an earlier trend around the hashtag "#NoEstimates." Below I sort these into [tiers](https://en.wikipedia.org/wiki/Tier_list).

## [#NoEstimates](https://holub.com/noestimates-an-introduction/)
...
## [#NoStandups](https://holub.com/nostandups/)
...
## [#NoRetrospectives](https://holub.com/improvement-boards/)
...
This one goes in D tier: apart from being false advertising - it is _not_ advocating "no retrospectives" - it would also probably function better in the form of "here's how to give your retro meetings some teeth."
